...
train_pipeline = [
    ...
    dict(type='Collect3D', keys=['img', 'vectors', 'osm_masks'], meta_keys=(
        'token', 'ego2img', 'sample_idx', 'ego2global_translation',
        'ego2global_rotation', 'img_shape', 'scene_name', 'osm_masks'))
]
...
test_pipeline = [
    ...
    dict(type='PadMultiViewImages', size_divisor=32),
    dict(type='FormatBundleMap'),
    dict(type='Collect3D', keys=['img', 'osm_masks'], meta_keys=(
        'token', 'ego2img', 'sample_idx', 'ego2global_translation',
        'ego2global_rotation', 'img_shape', 'scene_name', 'osm_masks'))
]
