...
def preprocess_map(mask_config, vectors, patch_size, canvas_size, num_classes, thickness, angle_class):
    confidence_levels = [-1]
    vector_num_list = {}
    ...
    mask_flag = mask_config[0]
    mask_ratio = mask_config[1]
    patch_num_h = mask_config[2]
    patch_num_w = mask_config[3]
